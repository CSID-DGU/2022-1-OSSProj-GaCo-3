...
class Game:
    def __init__(self):
        ...
        # 배경 이미지 불러오기
        self.background = pygame.image.load("../image/map/Background.png")
        self.background = pygame.transform.scale(self.background, (WIDTH, HEIGHT))  # 크기 지정
        self.ground = pygame.image.load("../image/map/Start_Map.png")
        self.ground = pygame.transform.scale(ground, (WIDTH, HEIGHT))  # 크기 지정
    ...
    def run(self):
        ...
        while running:
            ...
            self.screen.blit(ground, (0, 0))  # 배경 그리기
                ...
                if event.type == pygame.KEYDOWN:  # 키가 눌러졌는지 확인
                    if event.key == pygame.K_LEFT:  # 캐릭터를 왼쪽으로
                        ...
                        player_frame, player_action, player_frameSpeed, player_animationMode, player_loop = change_playerAction(
                            player_frame, 0, player_action, 'walk_L', player_frameSpeed, player_walk_framspeed,
                            player_animationMode, True, player_loop, False)
                        keyLeft = True
                        keyRight = False
                    elif event.key == pygame.K_RIGHT:  # 캐릭터를 오른쪽으로
                        player_state = 1
                        player_frame, player_action, player_frameSpeed, player_animationMode, player_loop = change_playerAction(
                            player_frame, 0, player_action, 'walk_R', player_frameSpeed, player_walk_framspeed,
                            player_animationMode, True, player_loop, True)
                        keyLeft = False
                        keyRight = True
                    elif event.key == pygame.K_SPACE and player_action == 'stand_L':  # 캐릭터를 왼쪽으로 보며 점프
                        player_state = 3
                        player_frame, player_action, player_frameSpeed, player_animationMode, player_loop = change_playerAction(
                            player_frame, 11, player_action, 'Jump_L', player_frameSpeed, player_jump_framespeed,
                            player_animationMode, False, player_loop, False)
                        keyLeft = False
                        keyRight = False
                        player_vspeed = -15
                        ...
                        player_state = 3
                        player_frame, player_action, player_frameSpeed, player_animationMode, player_loop = change_playerAction(
                            player_frame, 0, player_action, 'Jump_R', player_frameSpeed, player_jump_framespeed,
                            player_animationMode, False, player_loop, True)
                        keyLeft = False
                        keyRight = False
                        player_vspeed = -15
                        ...
                        player_state = 2
                        player_frame, player_action, player_frameSpeed, player_animationMode, player_loop = change_playerAction(
                            player_frame, 0, player_action, 'Run_L', player_frameSpeed, player_run_framspeed,
                            player_animationMode, True, player_loop, False)
                        keyLeft_Run = True
                        keyRight_Run = False
                        keyLeft = False
                        ...
                        player_state = 2
                        player_frame, player_action, player_frameSpeed, player_animationMode, player_loop = change_playerAction(
                            player_frame, 0, player_action, 'Run_R', player_frameSpeed, player_run_framspeed,
                            player_animationMode, True, player_loop, True)
                        keyLeft_Run = False
                        keyRight_Run = True
                        keyLeft = False
            ...
            if player_state == 1:
                ...
                if event.type == pygame.KEYUP:  # 방향키를 떼면 멈춤
                    if event.key == pygame.K_LEFT and keyLeft == True:
                        player_state = 0
                        player_frame, player_action, player_frameSpeed, player_animationMode, player_loop = change_playerAction(
                            player_frame, 0, player_action, 'stand_L', player_frameSpeed, player_stand_framespeed,
                            player_animationMode, True, player_loop, False)
                        keyLeft = False
                    elif event.key == pygame.K_RIGHT and keyRight == True:
                        player_frame, player_action, player_frameSpeed, player_animationMode, player_loop = change_playerAction(
                            player_frame, 0, player_action, 'stand_R', player_frameSpeed, player_stand_framespeed,
                            player_animationMode, True, player_loop, True)
                        player_state = 0
                        keyRight = False
...
background = pygame.transform.scale(background, (WIDTH, HEIGHT)) #크기 지정
ground = pygame.image.load("../image/map/Start_Map.png")
ground = pygame.transform.scale(ground, (WIDTH, HEIGHT)) #크기 지정
