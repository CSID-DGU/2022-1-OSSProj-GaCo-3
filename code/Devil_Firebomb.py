...
class Devil_Firebomb(pygame.sprite.Sprite):
    def __init__(self, pos, SIZE, groups, obstacle_sprites):
        ...
        self.hitbox = self.rect.inflate(-SIZE[0]/4, 0)#이미지 사각형의 크기 줄여 HitBox로 사용
        self.scale = SIZE
        ...
        self.FirestormSound = soundManager.load_sound('Devil_Firestorm', 'sound/devil/explosion.wav')
        #self.FirestormSound.set_volume(0.4)
